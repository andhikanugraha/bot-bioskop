...
class InMemoryDataStore {
  ...
  addScreening(screening) {
    return this.insertOrUpdate(this.screenings, screening, screening);
  }
  ...
  findCities(query) {
    return this.findIn(this.cities, query);
  }

  findTheatres(query) {
    return this.findIn(this.theatres, query);
  }

  findFilms(query) {
    return this.findIn(this.films, query);
  }

  findScreenings(query) {
    return this.findIn(this.screenings, query);
  }
}
